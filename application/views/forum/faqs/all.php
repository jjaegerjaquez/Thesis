...
<body>
        ...
        <div class="tabbable-panel">
          <div class="tabbable-line">
            <ul class="nav nav-tabs ">
              <li>
                <a href="<?php echo base_url(); ?>Forum/all" class="tab">
                Topics </a>
              </li>
              <li class="active">
                <a href="<?php echo base_url(); ?>Forum/faqs" class="tab">
                FAQs </a>
              </li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_default_1">
                <div class="row search-box">
                  <form class="" action="<?php echo base_url(); ?>Forum/result" method="post">
  ...
  $("#search").keyup(function(){
       var str=  $("#search").val();
       if(str == "") {
         $(location).attr('href','<?php echo base_url(); ?>Forum/faqs');
       }else {
               $.get( "<?php echo base_url();?>Forum/search?filter=faqs&keyword="+str, function( data ){
                   $( "#table" ).html( data );
            });
       }
   });
