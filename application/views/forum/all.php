      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main-content">
        <div class="table-responsive">
          <table class="table">
            <thead>
              <tr>
                <th style="border-bottom:2px solid #f37430;">Topics</th>
            ...
            <tbody id="table">
              <?php if (!empty($topics)): ?>
                <?php foreach ($topics as $key => $topic): ?>
                  <tr>
                    <td><a href="/Forum/topic/<?php echo $topic->topic_id?>"><?php echo $topic->topic ?></a></td>
                    <td><?php $date = strtotime($topic->date_created); echo date('F j Y',$date)?></td>
                  </tr>
                <?php endforeach; ?>
              <?php endif; ?>
            </tbody>
