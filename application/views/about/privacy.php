...
<body>
  ...
  <div class="container">
	...
	<ul class="" style="list-style:none;">
		<li> Operates the  website, which provides the SERVICE.</li>
		<br>
		...
		<li><span style="font-weight:bold;">Information Collection and Use</span></li>
		...
		<br>
		<li><span style="font-weight:bold;">Log Data</span></li>
		...
		<br>
		<li><span style="font-weight:bold;">Cookies</span></li>
		...
		<br>
		<li>Our website uses these “cookies” to collection information and to improve our Service. You have the option to either accept or refuse these cookies, and know when a cookie is being sent to your computer. If you choose to refuse our cookies, you may not be able to use some portions of our Service.</li>
		<br>
		<li><span style="font-weight:bold;">Service Providers</span></li>
		<li>We may employ third-party companies and individuals due to the following reasons:
      <ul>
		...
		<span style="font-weight:bold;">Links to Other Sites</span>
		<p>Our Service may contain links to other sites. If you click on a third-party link, you will be directed to that site. Note that these external sites are not operated by us. Therefore, we strongly advise you to review the Privacy Policy of these websites. We have no control over, and assume no responsibility for the content, privacy policies, or practices of any third-party sites or services.</p>
		<span style="font-weight:bold;">Children’s Privacy</span>
		<p>Our Services do not address anyone under the age of 13. We do not knowingly collect personal identifiable information from children under 13. In the case we discover that a child under 13 has provided us with personal information, we immediately delete this from our servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact us so that we will be able to do necessary actions.</p>
		<span style="font-weight:bold;">Changes to This Privacy Policy</span>
