  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="/Edit/Contacts"><i class="fa fa-user"></i> <span>Contacts</span></a></li>
        ...
        <div class="box-body">
          <form action ="" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label>Email:</label>
              <input type="text" name="business_name" class="form-control" value="samgyupsalamatresto@gmail.com">
              <span style="color:red" class="help-block"><?php echo form_error('business_name'); ?></span>
            </div>
            <div class="form-group">
              <label>Facebook:</label>
              <input type="text" name="business_name" class="form-control" value="samgyupsalamatresto@facebook.com">
              <span style="color:red" class="help-block"><?php echo form_error('business_name'); ?></span>
            </div>
            <div class="form-group">
              <label>Instagram:</label>
              <input type="text" name="business_name" class="form-control" value="@samgyupsalamat_resto">
              <span style="color:red" class="help-block"><?php echo form_error('business_name'); ?></span>
            </div>
