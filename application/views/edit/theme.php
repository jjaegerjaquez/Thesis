  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="/Edit/Theme"><i class="fa fa-heart"></i> <span>Theme</span></a></li>
        <!-- <li class="treeview">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-xs-18 col-sm-6 col-md-4">
              <div class="thumbnail">
                <img src="/uploads/images/t1.jpg" alt="">
                  <div class="caption">
                    <h4>Template 1</h4>
                    <div class="form-group">
                      <a href="#" class="btn btn-info btn-sm" role="button">Apply</a>
                      <a href="#" class="btn btn-primary btn-sm" role="button">View Website</a>
                    </div>
                </div>
              </div>
            </div>
            <div class="col-xs-18 col-sm-6 col-md-4">
              <div class="thumbnail">
                <img src="/uploads/images/t2.png" alt="">
                  <div class="caption">
                    <h4>Template 2</h4>
                    <div class="form-group">
                      <a href="#" class="btn btn-info btn-sm" role="button">Apply</a>
            ...
            <div class="col-xs-18 col-sm-6 col-md-4">
              <div class="thumbnail">
                <img src="/uploads/images/t3.jpg" alt="">
                  <div class="caption">
                    <h4>Template 3</h4>
                    <div class="form-group">
                      <a href="#" class="btn btn-info btn-sm" role="button">Apply</a>
