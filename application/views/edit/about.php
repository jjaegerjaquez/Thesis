  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="/Edit/About"><i class="fa fa-edit"></i> <span>About</span></a></li>
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="form-group">
            <img src="/public/img/Template1/image4.jpg" width="300px" height="250px" alt="">
          </div>
