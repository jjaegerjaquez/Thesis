...
<body>
  ...
  <div class="container">
    <div class="row content-header">
      ...
      <span class="content-title">Restaurants in Manila</span>
    </div>
    <div class="row content">
      ...
      <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 main-content">
        ...
        <div class="media" style="background-color:#fff;padding:15px 15px 15px 15px;">
          <div class="pull-left visible-lg visible-md visible-sm media-left"><img class="media-object" src="/uploads/images/user.jpg" alt="/uploads/images/user.jpg"></div>
          <div class="media-body rating">
            ...
            <h3 class="media-heading business-title">Samgyupsalamat</h3>
            <div class="separator"></div>
            <ul>
              <li class="detail-list"><i class="ion-location icons"></i> 911 Kapitan Tikong Corner Leon Guinto Street, Malate</li>
              <li class="detail-list"><i class="ion-iphone icons"></i> +63 9778423427</li>
              <li class="detail-list"><i class="ion-ios-telephone icons"></i> N/A</li>
            </ul>
            <div class="row">
              <div class="col-xs-6">
