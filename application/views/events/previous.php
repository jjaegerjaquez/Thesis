...
<body>
  ...
  <div class="container">
    ...
    <div class="previous">
      <form class="" action="<?php echo base_url(); ?>Event/all" method="post">
    ...
    <div class="row content">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main-content text-center">
        <div class="text-center title">
          <h2 class="event-header-title">Finished Events</h2>
        </div>
        <?php if (!empty($events)): ?>
            ...
            <div class="col-sm-4" >
              <div class="date">
                <span>
        		  ...
        		  <div class="thumbnail">
                <a href="/Event/preview/<?php echo $event->event_id?>">
                <?php if (!empty($event->image)): ?>
                  <img src="<?php echo $event->image?>" alt="image"> </a>
                <?php else: ?>
                  <img src="<?php echo base_url() ?>/public/img/events/def-img-l.jpg" alt="image"> </a>
                <?php endif; ?>
                <div class="list-text">
