...
<body>
  ...
  <div class="container">
    ...
    <div class="previous">
      <form class="" action="<?php echo base_url(); ?>Event/result?key=previous" method="post">
        <button class="btn" type="submit" name="button">Finished Events</button>
      </form>
    </div>
    <div class="row content">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main-content text-center">
        <div class="text-center title">
          <h2 class="event-header-title">Events</h2>
          <!-- of <?php echo date("Y"); ?> -->
        </div>
        <?php if (!empty($events)): ?>
