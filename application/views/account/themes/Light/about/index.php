    ...
    <div class="row">
      <div class="col-lg-3" style="background-color:#fff;border-right:10px solid #ebe9e9;padding-top: 20px;">
        ...
        <div class="vertical-menu">
          ...
          <a href="<?php echo base_url(); ?>Light/about" class="active">About Page Settings</a>
      ...
      <div class="col-lg-9">
        ...
        <div class="col-lg-6" style="background-color:#fff;">
          ...
          <form class="" action="<?php echo base_url(); ?>Light/save_about" method="post" enctype="multipart/form-data">
            <div class="form-group">
...
$('.cropped_image').on('click', function (ev) {
    ...
    var file_input = $('#images').val();
		$.ajax({
			url: "<?php echo base_url() ?>Light/upload_about_bg",
			type: "POST",
			data: {"image":response,"file":file_input},
			success: function (data) {
        alert(data);
        $(location).attr('href','<?php echo base_url() ?>Light/about');
			}
		});
	});
});
