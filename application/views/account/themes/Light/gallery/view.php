  ...
  <div class="container">
    <div class="row">
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Light/gallery">Customize Gallery</a></li>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 box-div2">
        <div class="row text-title header-row">
          ...
          <a href="<?php echo base_url(); ?>Light/gallery" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
          <hr>
        </div>
