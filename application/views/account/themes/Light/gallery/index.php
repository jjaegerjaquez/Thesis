    ...
    <div class="row">
      <div class="col-lg-3" style="background-color:#fff;border-right:10px solid #ebe9e9;padding-top: 20px;">
        ...
        <div class="vertical-menu">
          ...
          <a href="/Light/gallery" class="active">Gallery Page Settings</a>
      ...
      <div class="col-lg-9" style="background-color:#fff;">
        <div class="row text-title header-row">
          <h2 class="">Gallery</h2>
          <a href="/Light/add_image" class="btn btn-success"><i class="fa fa-plus"></i> Add Image</a>
          <hr>
        </div>
            ...
            <tbody>
              <?php foreach ($gallery_images as $key => $image): ?>
                <tr role="row" class="odd">
                  ...
                  <td>
                    <a href="/Light/view_image/<?php echo $image->content_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                    <a href="/Light/edit_image/<?php echo $image->content_id ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                    <a href="/Light/delete_image/<?php echo $image->content_id ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
