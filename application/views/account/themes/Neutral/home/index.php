    ...
    <div class="row">
      <div class="col-lg-3" style="background-color:#fff;border-right:10px solid #ebe9e9;padding-top: 20px;">
        ...
        <div class="vertical-menu">
          ...
          <a href="/Neutral/home" class="active">Home Page Settings</a>
      ...
      <div class="col-lg-9" style="background-color:#fff;">
        ...
        <form class="" action="/Neutral/save_home" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <label>Background Image:</label>
          </div>
          <?php if (!empty($home_bg->value)): ?>
            <img src="/uploads/<?php echo $account->username?>/<?php echo $home_bg->value?>" alt="" height="300px" height="300px">
          <?php else: ?>
