        ...
        <div class="col-lg-6 box-div2">
          ...
          <div class="form-group">
            <?php if (!empty($home_bg->value)): ?>
              <img class="center-block img-responsive" src="<?php echo $home_bg->value?>" alt="" height="200px" height="230px">
            <?php else: ?>
              <img class="center-block img-responsive" src="<?php echo base_url(); ?>public/img/img.jpg" alt="" height="230px">
            <?php endif; ?>
          </div>
          <div class="form-group">
