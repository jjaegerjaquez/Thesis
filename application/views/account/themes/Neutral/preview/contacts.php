    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 mx-auto">
          <h2>Contact Us</h2>
          <i class="fa fa-map-marker" aria-hidden="true"></i> 911 Kapitan Tikong Corner LeonGuinto Street, Malate
          <br><i class="fa fa-phone" aria-hidden="true"></i> +639778423427
          <br><i class="fa fa-envelope" aria-hidden="true"></i> youremail@example.com
