...
<body>
  ...
  <section class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="col-lg-5" style="background-color:#fff;border-right:5px solid #ebe9e9;border-left:5px solid #ebe9e9;padding-top: 20px;padding-bottom:20px;margin-bottom:20px;">
        ...
        <div class="col-lg-7" style="background-color:#fff;padding-bottom:20px;border-right:5px solid #ebe9e9;border-left:5px solid #ebe9e9;padding-top: 20px;">
          <div class="row text-title header-row">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="category" id="category">
                ...
                <?php foreach ($categories as $key => $category): ?>
                  <?php if ($category->category == $details->category): ?>
                  <?php else: ?>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="city_province" id="city_province">
                    ...
                    <?php foreach ($localities as $key => $locality): ?>
                      <?php if ($locality->locality == $details->locality): ?>
                      <?php else: ?>
