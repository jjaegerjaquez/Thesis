    ...
    <div class="row">
      ...
      <div class="col-lg-9" style="background-color:#fff;">
        <div class="row text-title header-row">
          ...
          <a href="<?php echo base_url(); ?>Neutral/add_image" class="btn btn-success"><i class="fa fa-plus"></i> Add Image</a>
          <hr>
        </div>
            ...
            <tbody>
              <?php foreach ($gallery_images as $key => $image): ?>
                <tr role="row" class="odd">
                  ...
                  <td>
                    <a href="<?php echo base_url(); ?>Neutral/view_image/<?php echo $image->content_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                    <a href="<?php echo base_url(); ?>Neutral/edit_image/<?php echo $image->content_id ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                    <a href="<?php echo base_url(); ?>Neutral/delete_image/<?php echo $image->content_id ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
