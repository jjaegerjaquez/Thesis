    ...
    <div class="row">
      <div class="col-lg-3" style="background-color:#fff;border-right:10px solid #ebe9e9;padding-top: 20px;">
        ...
        <div class="vertical-menu">
          ...
          <a href="<?php echo base_url(); ?>Neutral/about" class="active">About Page Settings</a>
      ...
      <div class="col-lg-9" style="background-color:#fff;">
        ...
        <div class="col-lg-6">
          ...
          <form class="" action="<?php echo base_url(); ?>Neutral/save_about" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label>About Page Title*</label>
              <input type="text" name="title" class="form-control" value="<?php if (!empty($about_title->value)) { echo $about_title->value; } ?>" maxlength="140" placeholder="Add text here">
              <span style="color:red" class="help-block"><?php echo form_error('about_page_title'); ?></span>
            </div>
...
$('.cropped_image').on('click', function (ev) {
    ...
    var file_input = $('#images').val();
		$.ajax({
			url: "<?php echo base_url() ?>Neutral/upload_about_header_img",
			type: "POST",
			data: {"image":response,"file":file_input},
			success: function (data) {
        alert(data);
        $(location).attr('href','<?php echo base_url() ?>Neutral/about');
			}
		});
	});
});
