    ...
    <div class="row">
      <div class="col-lg-3" style="background-color:#fff;border-right:10px solid #ebe9e9;padding-top: 20px;">
        ...
        <div class="vertical-menu">
          ...
          <a href="/Neutral/about" class="active">About Page Settings</a>
      ...
      <div class="col-lg-9" style="background-color:#fff;">
        ...
        <form class="" action="/Neutral/save_about" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" value="<?php if (!empty($about_title->value)) { echo $about_title->value; } ?>" maxlength="50">
