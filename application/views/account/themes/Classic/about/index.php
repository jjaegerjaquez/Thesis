...
<body>
  ...
  <div class="container">
    <div class="row">
      <ul class="breadcrumb">
        ...
        <li class="active">Customizing about page</li>
      </ul>
      <div class="col-lg-3">
        <div class="row">
  ...
  <section class="container">
    <div class="row">
      <div class="col-lg-3" style="background-color:#fff;margin-bottom:20px;border-right:10px solid #ebe9e9;border-left:10px solid #ebe9e9;padding-top: 20px;">
        ...
        <div class="vertical-menu">
          ...
          <a href="<?php echo base_url(); ?>Classic/about" class="active">About Page Settings</a>
      ...
      <div class="col-lg-9">
        <div class="col-lg-6" style="background-color:#fff;padding-bottom:20px;margin-bottom:20px;">
          <div class="row text-title header-row">
            <h3 class="title">Featured Image:</h3>
            <hr>
          </div>
          <div class="form-group">
            <?php if (!empty($featured_image->value)): ?>
              <img src="<?php echo $featured_image->value?>" alt="" height="230px">
            <?php else: ?>
              <img src="<?php echo base_url(); ?>public/img/img.jpg" alt="" height="230px" class="img-responsive">
            <?php endif; ?>
          </div>
          <div class="form-group">
        ...
        <div class="col-lg-6" style="background-color:#fff;padding-bottom:20px;border-right:10px solid #ebe9e9;border-left:10px solid #ebe9e9;">
          ...
          <form class="" action="<?php echo base_url(); ?>Classic/save_about" method="post" enctype="multipart/form-data">
              <div class="form-group input-width center-block">
                <label>Description*</label>
                <textarea class="form-control" name="description" rows="15" maxlength="800" placeholder="Add description"><?php if (!empty($about_description->value)) { echo $about_description->value; } ?></textarea>
              </div>
              <div class="form-group">
...
$('.cropped_image').on('click', function (ev) {
  if ($('#images').val()=='') {
    ...
    var file_input = $('#images').val();
		$.ajax({
			url: "<?php echo base_url() ?>Classic/upload_about_featured_img",
			type: "POST",
