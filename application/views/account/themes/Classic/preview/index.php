...
<body onscroll="stickNav()">
  ...
  <div class="container-fluid contact-custom">
    ...
    <div class="form-group">
      <span class="location-custom"><i class="fa fa-map-marker icon-custom"></i>Your address goes here</span>
    </div>
    <div class="form-group">
      <span class="location-custom"><i class="fa fa-phone icon-custom"></i>Your telephone number goes here</span>
    </div>
    <div class="form-group">
      <span class="location-custom"><i class="fa fa-envelope icon-custom"></i>youremail@example.com</span>
    </div>
    <div class="form-group contacts">
      <span style="follow-us">Follow Us</span>
      <div class="row">
        ...
        <a href="#"><span style="font-size:15px;color:#323339;"><i class="fa fa-twitter icon-custom"></i></span></a>
      </div>
    </div>
  </div>
