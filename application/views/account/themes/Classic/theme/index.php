        ...
        <div class="row text-title header-row">
          ...
          <div class="col-lg-12" style="padding-bottom:30px;">
            <?php foreach ($themes as $key => $theme): ?>
              <div class="col-lg-4" style="background-color:#3c3734;padding:20px 10px 10px 10px;border-radius:5px;border-right:5px solid #fff;border-left:5px solid #fff;margin-bottom: 10px;">
                <div class = "thumbnail">
