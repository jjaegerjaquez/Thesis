  ...
  <div class="container">
    <div class="row">
      <ul class="breadcrumb">
        ...
        <li class="active">Customizing image slider</li>
      </ul>
      <div class="col-lg-3">
        <div class="row">
    ...
    <div class="row">
      <div class="col-lg-3" style="background-color:#fff;margin-bottom:20px;border-right:5px solid #ebe9e9;border-left:5px solid #ebe9e9;padding-top: 20px;">
        ...
        <div class="vertical-menu">
          ...
          <a href="<?php echo base_url(); ?>Classic/image_slider" class="active">Image Slider</a>
          <a href="<?php echo base_url(); ?>Classic/theme">Theme</a>
        </div>
      </div>
      <div class="col-lg-9" style="background-color:#fff;margin-bottom:20px;border-right:5px solid #ebe9e9;border-left:5px solid #ebe9e9;padding-top: 20px;">
        <div class="row text-title header-row">
          <h3 class="title">Image Slider</h3>
          <a href="<?php echo base_url(); ?>Classic/add_image_slider" class="btn btn-success"><i class="fa fa-plus"></i> Add Image</a>
          <hr>
        </div>
            ...
            <tbody>
              <?php foreach ($slider_images as $key => $image): ?>
                <tr role="row" class="odd">
                  <td>
                    <img src="<?php if (!empty($image->value)) { echo $image->value; } else { echo 'default-img.jpg'; }?>" alt="" height="100px" height="50px">
                  </td>
                  <td>
                    <a href="<?php echo base_url(); ?>Classic/view_slider_image/<?php echo $image->content_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                    <a href="<?php echo base_url(); ?>Classic/edit_slider_image/<?php echo $image->content_id ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                    <a href="<?php echo base_url(); ?>Classic/delete_slider_image/<?php echo $image->content_id ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
