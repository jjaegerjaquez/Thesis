    ...
    <div class="row">
      <div class="col-lg-3" style="background-color:#fff;border-right:10px solid #ebe9e9;padding-top: 20px;">
        ...
        <div class="vertical-menu">
          ...
          <a href="/Classic/image_slider" class="active">Image Slider</a>
      ...
      <div class="col-lg-9" style="background-color:#fff;">
        <div class="row text-title header-row">
          ...
          <a href="/Classic/add_image_slider" class="btn btn-success"><i class="fa fa-plus"></i> Add Image</a>
          <hr>
        </div>
            ...
            <tbody>
              <?php foreach ($slider_images as $key => $image): ?>
                <tr role="row" class="odd">
                  <td>
                    <img src="/uploads/<?php echo $account->username?>/<?php if (!empty($image->value)) { echo $image->value; } else { echo 'default-img.jpg'; }?>" alt="" height="100px" height="50px">
                  </td>
                  <td>
                    <a href="/Classic/view_slider_image/<?php echo $image->content_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                    <a href="/Classic/edit_slider_image/<?php echo $image->content_id ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                    <a href="/Classic/delete_slider_image/<?php echo $image->content_id ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
