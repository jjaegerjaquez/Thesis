  ...
  <div class="container">
    <div class="row">
      <ul class="breadcrumb">
        ...
        <li><a href="/Classic/gallery">Customize Image Slider</a></li>
    ...
    <div class="row">
      ...
      <div class="col-lg-9" style="background-color:#fff;">
        <div class="row text-title header-row">
          <h2 class="">Preview</h2>
          <a href="/Classic/image_slider" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
          <hr>
        </div>
        <div class="row" style="padding: 0 20px 20px 20px;">
          <img src="/uploads/themes/<?php echo $business->template?>/<?php if (!empty($image->value)) { echo $image->value; } else { echo 'default-img.jpg'; }?>" alt="">
        </div>
      </div>
    </div>
  </section>
