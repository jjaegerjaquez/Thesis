...
<body>
  ...
  <div class="container">
    <div class="row">
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Classic/gallery">Customize Image Slider</a></li>
  ...
  <section class="container">
    <div class="row">
      ...
      <div class="col-lg-9" style="background-color:#fff;border-right:5px solid #ebe9e9;border-left:5px solid #ebe9e9;padding-top: 20px;">
        <div class="row text-title header-row">
          <h3 class="">Preview</h3>
          <a href="<?php echo base_url(); ?>Classic/image_slider" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
          <hr>
        </div>
        <div class="row" style="padding: 0 20px 20px 20px;">
          <img src="<?php if (!empty($image->value)) { echo $image->value; } else { echo 'default-img.jpg'; }?>" class="img-responsive center-block" width="800px" height="600px">
        </div>
      </div>
    </div>
  </section>
