  ...
  <div class="container">
    <div class="row">
      <ul class="breadcrumb">
        ...
        <li><a href="/Classic/image_slider">Customize Image Slider</a></li>
  ...
  <section class="container">
    <div class="row">
      ...
      <div class="col-lg-9" style="background-color:#fff;">
        ...
        <form class="" action="/Classic/update_image_slider/<?php echo $image_slider->content_id?>" method="post" enctype="multipart/form-data">
