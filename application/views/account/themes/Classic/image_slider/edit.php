...
<body>
  ...
  <div class="container">
    <div class="row">
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Classic/image_slider">Customize Image Slider</a></li>
  ...
  <section class="container">
    <div class="row">
      ...
      <div class="col-lg-9" style="background-color:#fff;margin-bottom:20px;padding-bottom:20px;border-right:5px solid #ebe9e9;border-left:5px solid #ebe9e9;padding-top: 20px;">
...
$('.cropped_image').on('click', function (ev) {
    ...
    var file_input = $('#images').val();
		$.ajax({
			url: "<?php echo base_url() ?>Classic/update_image_slider/<?php echo $image_slider->content_id ?>",
			type: "POST",
			data: {"image":response,"file":file_input},
			success: function (data) {
        alert(data);
        $(location).attr('href','<?php echo base_url() ?>Classic/image_slider');
			}
		});
	});
});
