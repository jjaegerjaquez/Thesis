        ...
        <div class="col-lg-7" style="background-color:#fff;border-right:5px solid #ebe9e9;padding-top:20px;padding-bottom:20px;margin-bottom:20px;">
          ...
          <form class="" action="<?php echo base_url() ?>Account/save_profile" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="website_address" class="form-control" value="<?php if (!empty($details->website_url)): ?><?php echo $details->website_url ?><?php endif; ?>" placeholder="ex: https://www.google.com.ph">
