      ...
      <div class="box">
        ...
        <div class="box-body">
          <form action ="" method="post" enctype="multipart/form-data">
              <a href="/Theme/apply_theme/1" class="btn btn-primary"><i class=""></i> Template 1</a>
              <a href="/Theme/apply_theme/2" class="btn btn-info"><i class=""></i> Template 2</a>
              <a href="/Theme/apply_theme/3" class="btn btn-warning"><i class=""></i> Template 3</a>
