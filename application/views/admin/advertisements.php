  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="treeview"><a href="/Admin/Forum"><i class="fa fa-comment"></i> <span>Forum</span></a></li>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-4">
                  <label>Space 1</label>
                  <br>
                  <img src="/public/img/promo1.jpg" alt="" width="150px" height="150px">
                  <input class="" type="file" name="image" />
                  <div class="form-group">
                    <label>Ad title:</label>
                    <input type="text" name="business_name" class="form-control" value="Title">
                ...
                <div class="col-md-4">
                  <label>Space 2</label>
                  <br>
                  <img src="/public/img/barkadabg.jpg" alt="" width="150px" height="150px">
                  <input class="" type="file" name="image" />
                  <div class="form-group">
                    <label>Ad title:</label>
                    <input type="text" name="business_name" class="form-control" value="Title">
                ...
                <div class="col-md-4">
                  <label>Space 3</label>
                  <br>
                  <img src="/public/img/luggagebg.jpg" alt="" width="150px" height="150px">
                  <input class="" type="file" name="image" />
                  <div class="form-group">
                    <label>Ad title:</label>
                    <input type="text" name="business_name" class="form-control" value="Title">
