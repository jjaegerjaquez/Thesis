  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/Admin/forum">forums</a></li>
        <li class="active">Update "<?php echo $topic->topic?>"</li>
      </ol>
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form class="" action="/Admin/update_topic/<?php echo $topic->topic_id?>" method="post" enctype="multipart/form-data">
