  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Admin/forum">forums</a></li>
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form class="" action="<?php echo base_url(); ?>Admin/update_topic/<?php echo $topic->topic_id?>" method="post" enctype="multipart/form-data">
