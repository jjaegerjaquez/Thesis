  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="/Admin/Forum"><i class="fa fa-comment"></i> <span>Forum</span></a></li>
        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Topic:</label>
                <input type="text" name="business_name" class="form-control" value="Lorem ipsum">
