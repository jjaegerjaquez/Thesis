    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="/Admin/approve" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
                  ...
                  <tbody>
                      <?php foreach ($topics as $key => $topic): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="/Admin/disapprove/<?php echo $topic->topic_id  ?>" class="btn btn-warning"><i class="fa fa-exclamation-circle"></i> Disapprove</a>
