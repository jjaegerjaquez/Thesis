...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="/Admin/forum"><i class="fa fa-comments"></i> <span>Forum</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Topics
        <small>list of all forum topics</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="/Admin"><i class="fa fa-dashboard"></i> Admin</a></li>
        <li><a href="/Admin/forum">All</a></li>
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="/Admin/forum" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
          <a href="/Admin/view_approved" class="btn btn-success"><i class="fa fa-eye"></i> View approved topics</a>
                  ...
                  <tbody>
                      <?php foreach ($topics as $key => $topic): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="/Admin/approve_topic/<?php echo $topic->topic_id  ?>" class="btn btn-warning"><i class="fa fa-check"></i> Approve</a>
                            <a href="/Admin/delete_user_topic/<?php echo $topic->topic_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
