      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="" action="/Admin/create_topic" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label>Topic:</label>
                  <input type="text" name="topic" class="form-control" value="<?php echo set_value('topic'); ?>">
