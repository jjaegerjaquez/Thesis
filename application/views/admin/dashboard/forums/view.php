...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="<?php echo base_url(); ?>Admin/forum"><i class="fa fa-comments"></i> <span>Forum</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Comments
        <small>list of all comments</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="row">
              <div class="col-sm-12">
                <table class="table table-bordered table-striped dataTable" role="grid">
                  <thead>
                    <tr role="row">
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width:500px;">Comment</th>
                      ...
                      <?php if (!empty($posts)): ?>
                        <?php foreach ($posts as $key => $post): ?>
                          <tr role="row" class="odd">
                            ...
                            <td>
                              <a href="<?php echo base_url(); ?>Admin/delete_comment/<?php echo $post->post_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                            </td>
                          </tr>
                        <?php endforeach ?>
                      <?php else: ?>
