    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="/Admin/add_topic" class="btn btn-success"><i class="fa fa-plus"></i> Add Forum Topic</a>
          <a href="/Admin/approve" class="btn btn-success"><i class="fa fa-check"></i> Approve Topic</a>
                  ...
                  <tbody>
                      <?php foreach ($topics as $key => $topic): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="/Admin/edit_topic/<?php echo $topic->topic_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                            <a href="/Admin/delete_topic/<?php echo $topic->topic_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
