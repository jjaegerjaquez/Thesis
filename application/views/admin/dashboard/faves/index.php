...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="/Admin/dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Favorites
        <small>list of all favorites</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="/Admin" class="btn btn-success"><i class="ion-chevron-left"></i> Back to dashboard</a>
            ...
            <div class="row">
              <div class="col-sm-12">
                <table class="table table-bordered table-striped dataTable" role="grid">
                  <thead>
                    <tr role="row">
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width:300px;">Faved by</th>
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width:500px;">Business</th>
                  ...
                  <tbody>
                      <?php foreach ($faves as $key => $fave): ?>
                        <tr role="row" class="odd">
                          <td><?php echo $fave->username ?></td>
                          <td><?php echo $fave->business_name ?></td>
                          <td>
                            <!-- <a href="/Admin/view_fave/<?php echo $fave->vote_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a> -->
                            <a href="/Admin/delete_fave/<?php echo $fave->vote_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
