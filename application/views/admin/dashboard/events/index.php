    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="/Admin/add_event" class="btn btn-success"><i class="fa fa-plus"></i> Add Event</a>
                      ...
                      <?php if (!empty($events)): ?>
                        <?php foreach ($events as $key => $event): ?>
                          <tr role="row" class="odd">
                            ...
                            <td>
                              <a href="/Admin/view_event/<?php echo $event->event_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                              <a href="/Admin/edit_event/<?php echo $event->event_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                              <a href="/Admin/delete_event/<?php echo $event->event_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                            </td>
                          </tr>
                        <?php endforeach ?>
                      <?php else: ?>
