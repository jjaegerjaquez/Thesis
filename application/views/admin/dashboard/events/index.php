...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Events
        <small>list of all events</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="<?php echo base_url(); ?>Admin/add_event" class="btn btn-success"><i class="fa fa-plus"></i> Add Event</a>
          <a href="<?php echo base_url(); ?>Admin/finished" class="btn btn-success"><i class="ion-checkmark"></i> Finished Events</a>
                        ...
                        <?php foreach ($events as $key => $event): ?>
                          <tr role="row" class="odd">
                            ...
                            <td>
                              ...
                              <a href="<?php echo base_url(); ?>Admin/edit_event/<?php echo $event->event_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                              <a href="<?php echo base_url(); ?>Admin/delete_event/<?php echo $event->event_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                            </td>
                          </tr>
                        <?php endforeach ?>
                      <?php else: ?>
