            ...
            <div class="box-body">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" class="form-control" value="<?php echo set_value('title'); ?>" id="title">
                  <span style="color:red" class="help-block"><?php echo form_error('title'); ?></span>
                </div>
                <div class="form-group">
                  <label>Type of event:</label>
                  <input type="text" name="type" class="form-control"  id="type" value="<?php echo set_value('type'); ?>" placeholder="Holiday, Festival etc.">
                  <span style="color:red" class="help-block"><?php echo form_error('type'); ?></span>
                </div>
                <div class="form-group">
                  <label>Place:</label>
                  <input type="text" name="place" class="form-control" value="<?php echo set_value('place'); ?>" id="place">
