      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="" action="<?php echo base_url(); ?>Admin/save_event" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="type" class="form-control" value="<?php echo set_value('type'); ?>" placeholder="Holiday, Festival etc.">
                  <span style="color:red" class="help-block"><?php echo form_error('type'); ?></span>
                </div>
                <div class="form-group">
                  <label>Place:</label>
                  <input type="text" name="place" class="form-control" value="<?php echo set_value('place'); ?>">
                ...
                <div class="box-footer">
                  ...
                  <a href="<?php echo base_url(); ?>Admin/events" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
                </div>
              </form>
          </div>
      </div>
