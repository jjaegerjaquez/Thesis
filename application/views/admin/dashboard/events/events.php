          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="form-group">
                <label>Date:</label>
                <input type="date" name="business_name" class="form-control" value="">
                <span style="color:red" class="help-block"><?php echo form_error('image'); ?></span>
              </div>
              <div class="form-group">
                <label>Event:</label>
                <input type="text" name="business_name" class="form-control" value="Sinulog">
                <span style="color:red" class="help-block"><?php echo form_error('business_name'); ?></span>
              </div>
              <div class="form-group">
                <label>Location:</label>
                <input type="text" name="business_name" class="form-control" value="Baguio">
                <span style="color:red" class="help-block"><?php echo form_error('business_name'); ?></span>
              </div>
