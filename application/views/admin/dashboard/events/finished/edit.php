            ...
            <div class="box-body">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <a href="<?php echo base_url(); ?>Admin/finished" class="btn btn-danger" style="margin-top:5px;"><i class="fa fa-chevron-left"></i> Back</a>
                </div>
              </div>
            </div><!-- /.box-body -->
          </div>
...
$('.cropped_image').on('click', function (ev) {
  if ($('#images').val()=='') {
    ...
    var description = $('#description').val();
		$.ajax({
			url: "<?php echo base_url() ?>Admin/update_finished_event/<?php echo $event->event_id?>",
			type: "POST",
        ...
        if (data == 'Please select an image') {
          ...
          $('#upload-lbl').hide();
          alert(data);
          $(location).attr('href','<?php echo base_url() ?>Admin/finished');
        }
