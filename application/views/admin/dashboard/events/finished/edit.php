      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="" action="<?php echo base_url(); ?>Admin/update_finished_event/<?php echo $event->event_id?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-footer">
                  ...
                  <a href="<?php echo base_url(); ?>Admin/finished" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
                </div>
              </form>
          </div>
      </div>
