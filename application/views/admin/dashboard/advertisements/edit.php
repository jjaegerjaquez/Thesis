  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class=""><a href="/Admin/categories"><i class="fa fa-edit"></i> <span>Categories</span></a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form class="" action="/Admin/update_ad/<?php echo $ad->advertisement_id?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-inline">
                <div class="form-group">
                  <label>Start:</label>
                  <input type="date" name="start" value="<?php echo $ad->start_date?>">
                  <span style="color:red" class="help-block"><?php echo form_error('start'); ?></span>
                </div>
                <div class="form-group">
                  <label>End:</label>
                  <input type="date" name="end" value="<?php echo $ad->end_date?>">
                  <span style="color:red" class="help-block"><?php echo form_error('end'); ?></span>
                </div>
              </div>
              <div class="form-group">
                <label>Business ID:</label>
                <input type="text" name="business_id" class="form-control" value="<?php echo $ad->business_id?>">
                <span style="color:red" class="help-block"><?php echo form_error('business_id'); ?></span>
              </div>
              <div class="form-group">
                <label>Title:</label>
                <input type="text" name="title" class="form-control" value="<?php echo $ad->title?>">
                <span style="color:red" class="help-block"><?php echo form_error('title'); ?></span>
              </div>
              <div class="form-group">
                <label>Subtext:</label>
                <input type="text" name="subtext" class="form-control" value="<?php echo $ad->subtext?>">
                <span style="color:red" class="help-block"><?php echo form_error('subtext'); ?></span>
              </div>
              <div class="form-group input-width center-block">
                <label>Description:</label>
                <textarea class="form-control" name="description"><?php echo $ad->description?></textarea>
              ...
              <div class="box-footer">
                ...
                <a href="/Admin/advertisements" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
              </div>
            </form>
        </div>
    </section>
