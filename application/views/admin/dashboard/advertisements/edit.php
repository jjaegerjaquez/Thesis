  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class=""><a href="<?php echo base_url(); ?>Admin/categories"><i class="fa fa-edit"></i> <span>Categories</span></a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form class="" action="<?php echo base_url(); ?>Admin/update_ad/<?php echo $ad->advertisement_id?>" method="post" enctype="multipart/form-data">
