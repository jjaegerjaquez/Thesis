  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                ...
                <?php if (!empty($priorities)): ?>
                  <?php foreach ($priorities as $key => $priority_ad): ?>
                    <tr role="row" class="odd">
                      ...
                      <td>
                        <a href="/Admin/view_ad/<?php echo $priority_ad->advertisement_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        <a href="/Admin/edit_ad/<?php echo $priority_ad->advertisement_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                        <a href="/Admin/delete_ad/<?php echo $priority_ad->advertisement_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                <?php else: ?>
      ...
      <div class="col-md-6">
        <div class="box">
          <div class="box-header with-border">
            <a href="/Admin/add_ad/Regular" class="btn btn-success"><i class="fa fa-plus"></i> Add regular ad</a>
            <div class="box-tools pull-right">
              <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                <i class="fa fa-minus"></i></button>
            </div>
                ...
                <?php if (!empty($regulars)): ?>
                  <?php foreach ($regulars as $key => $regular_ad): ?>
                    <tr role="row" class="odd">
                      ...
                      <td>
                        <a href="/Admin/view_ad/<?php echo $regular_ad->advertisement_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        <a href="/Admin/edit_ad/<?php echo $regular_ad->advertisement_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                        <a href="/Admin/delete_ad/<?php echo $regular_ad->advertisement_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                <?php else: ?>
