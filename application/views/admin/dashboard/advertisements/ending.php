    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="/Admin/advertisements" class="btn btn-success"><i class="ion-chevron-left"></i> Back</a>
                      ...
                      <?php if (!empty($endings)): ?>
                        <?php foreach ($endings as $key => $ending): ?>
                          <tr role="row" class="odd">
                            ...
                            <?php endif; ?></td>
                            <td>
                              <a href="/Admin/notify/<?php echo $ending->advertisement_id ?>" class="btn btn-primary"><i class="ion-email"></i> Notify</a>
                              <a href="/Admin/edit_event/<?php echo $ending->advertisement_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                              <a href="/Admin/delete_event/<?php echo $ending->advertisement_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                            </td>
                          </tr>
                        <?php endforeach ?>
                      <?php else: ?>
