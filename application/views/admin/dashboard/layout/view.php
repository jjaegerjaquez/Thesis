  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Admin/about_page">Back</a></li>
        <li class="active">View <?php echo $detail->title?></li>
      </ol>
    <!-- Main content -->
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              <tr>
                ...
                <td><?php echo $detail->content_id;?></td>
              </tr>
              <tr>
            ...
            <a href="<?php echo base_url(); ?>Admin/about_page" class="btn btn-danger pull-right"><i class="fa fa-chevron-left"></i> Back</a>
          </div>
        </div>
      </div>
    </section>
