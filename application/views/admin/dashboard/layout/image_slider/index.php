...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active  treeview">
          ...
          <ul class="treeview-menu">
            <li class="active  treeview"><a href="<?php echo base_url(); ?>Admin/image_slider"><i class="fa fa-angle-right"></i>Image Slider</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Image slider
        <small>list of all image slider</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>Admin"><i class="fa fa-dashboard"></i> Admin</a></li>
        <li class="active">Image sliders</li>
      </ol>
    <!-- Main content -->
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="<?php echo base_url(); ?>Admin/add_image_slider" class="btn btn-success"><i class="fa fa-plus"></i> Upload image slider</a>
            ...
            <div class="row">
              <div class="col-sm-12">
                <table class="table table-bordered table-striped dataTable" role="grid">
                  <thead>
                    <tr role="row">
                      <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width:500px;">Image</th>
                      ...
                      <?php foreach ($image_sliders as $key => $image_slider): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url(); ?>Admin/delete_image_slider/<?php echo $image_slider->content_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                    <?php else: ?>
