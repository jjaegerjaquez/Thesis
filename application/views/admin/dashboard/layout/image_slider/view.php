  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Admin/image_slider">Back</a></li>
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="form-group">
            <img src="<?php if (!empty($image_slider->value)) { echo $image_slider->value; } else { echo 'default-img.jpg'; }?>" class="img-responsive center-block" width="800px" height="600px">
          </div>
          <a href="<?php echo base_url(); ?>Admin/image_slider" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
        </div>
      </div>
    </section>
    <!-- /.content -->
