        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="treeview"><a href="<?php echo base_url(); ?>Admin/image_slider"><i class="fa fa-angle-right"></i>Image Slider</a></li>
              ...
              <li class="active treeview"><a href="<?php echo base_url(); ?>Admin/site_logo"><i class="fa fa-angle-right"></i>Site Logo</a></li>
        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body text-center">
              <div class="col-lg-6" style="background-color:#bdbdbd;padding-top:75px;padding-bottom:75px;">
                <?php if (!empty($logo->value)): ?>
                  <img src="<?php echo $logo->value?>" alt="" width="300px" height="100px">
                <?php else: ?>
                  <img src="<?php echo base_url(); ?>public/img/layout/default-logo.png" alt="" width="300px" height="150px">
                <?php endif; ?>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <div id="upload-image" style="background-color:#424242;"></div>
                </div>
                <div class="form-group">
...
$('.cropped_image').on('click', function (ev) {
  if ($('#images').val()=='') {
    ...
    var file_input = $('#images').val();
		$.ajax({
			url: "<?php echo base_url() ?>Admin/upload_site_logo",
			type: "POST",
			data: {"image":response,"file":file_input},
			success: function (data) {
        $('#upload-lbl').hide();
        alert(data);
        $(location).attr('href','<?php echo base_url() ?>Admin/site_logo');
