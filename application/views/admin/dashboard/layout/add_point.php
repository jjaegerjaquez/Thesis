      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="" action="<?php echo base_url(); ?>Admin/save_detail" method="post">
                <div class="col-lg-offset-3 col-lg-6">
                  <div class="form-group">
                    <label>Detail</label>
                    <input type="text" name="detail_title" class="form-control" value="" maxlength="80" placeholder="Title">
                  ...
                  <div class="form-group input-width center-block">
                    ...
                    <textarea class="form-control" name="detail_description" rows="8" maxlength="800" placeholder="Explain it here..."></textarea>
