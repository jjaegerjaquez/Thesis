      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="" action="<?php echo base_url(); ?>Admin/update_detail/<?php echo $detail->content_id?>" method="post">
                <div class="col-lg-offset-3 col-lg-6">
                  <div class="form-group">
                    <label>Detail</label>
                    <input type="text" name="detail_title" class="form-control" value="<?php if (!empty($detail->title)): ?><?php echo $detail->title ?><?php endif; ?>" maxlength="80">
                    <span style="color:red" class="help-block"><?php echo form_error('detail_title'); ?></span>
                  </div>
                  <div class="form-group input-width center-block">
                    <label>Description</label>
                    <textarea class="form-control" name="detail_description" rows="8" maxlength="800"><?php if (!empty($detail->value)): ?><?php echo $detail->value ?><?php endif; ?></textarea>
                    <span style="color:red" class="help-block"><?php echo form_error('detail_description'); ?></span>
                  </div>
                  <div class="form-group">
                    <button type="submit" name="create" class="btn btn-success" value="Add"><i class="fa fa-floppy-o"></i> Save</button>
                    <a href="<?php echo base_url(); ?>Admin/about_page" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
                  </div>
                </div>
              </div>
                <!-- /.box-body -->
