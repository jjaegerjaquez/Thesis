  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="treeview"><a href="/Admin"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        ...
        <li class="treeview"><a href="/Admin/About"><i class="fa fa-edit"></i> <span>Categories</span></a></li>
        <li class="treeview"><a href="/Admin/Gallery"><i class="fa fa-calendar"></i> <span>Events</span></a></li>
        <li class="treeview"><a href="/Admin/Contacts"><i class="fa fa-comments"></i> <span>Forum</span></a></li>
        <li class="treeview"><a href="/Admin/themes"><i class="fa fa-cog"></i> <span>Themes</span></a></li>
        <li class="treeview"><a href="/Admin/Theme"><i class="fa fa-usd"></i> <span>Advertisements</span></a></li>
        <!-- <li class="treeview">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="form-group">
                <label>Logo</label>
                <br>
                <img src="/uploads/images/logo.png" width="200px" height="200px" alt="">
              ...
              <div class="row">
                <div class="col-md-4">
                  <img src="/public/img/image1.jpg" alt="" width="300px" height="150px">
                  <input class="" type="file" name="image" />
                </div>
                <div class="col-md-4">
                  <img src="/public/img/image2.jpg" alt="" width="300px" height="150px">
                  <input class="" type="file" name="image" />
                </div>
                <div class="col-md-4">
                  <img src="/public/img/image3.jpg" alt="" width="300px" height="150px">
                  <input class="" type="file" name="image" />
                </div>
              </div>
            </div>
