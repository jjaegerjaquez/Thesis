  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View <?php echo $theme->theme?></li>
      </ol>
    <!-- Main content -->
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              <tr>
                ...
                <td><img src="<?php echo base_url(); ?>uploads/images/admin/themes/<?php echo $theme->image?>" class="img-responsive" style="width:350px"/></td>
              </tr>
              <tr>
            ...
            <a href="<?php echo base_url(); ?>Admin/themes" class="btn btn-danger pull-right"><i class="fa fa-chevron-left"></i> Back</a>
          </div>
        </div>
      </div>
    </section>
