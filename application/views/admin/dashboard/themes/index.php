    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="<?php echo base_url(); ?>Admin/add_theme" class="btn btn-success"><i class="fa fa-plus"></i> Add Theme</a>
                  ...
                  <tbody>
                      <?php foreach ($themes as $key => $theme): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>Admin/view_theme/<?php echo $theme->theme_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                            <a href="<?php echo base_url(); ?>Admin/edit_theme/<?php echo $theme->theme_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                            <a href="<?php echo base_url(); ?>Admin/delete_theme/<?php echo $theme->theme_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
