      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="" action="/Admin/save_theme" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="theme_name" class="form-control" value="<?php echo set_value('theme_name'); ?>" maxlength="50">
                  <span style="color:red" class="help-block"><?php echo form_error('theme_name'); ?></span>
                </div>
                <div class="form-group">
                  <label>Author:</label>
                  <input type="text" name="author" class="form-control" value="<?php echo set_value('author'); ?>" maxlength="50">
                  <span style="color:red" class="help-block"><?php echo form_error('author'); ?></span>
                </div>
                <div class="form-group input-width center-block">
                  <label>Description:</label>
                  <textarea class="form-control" name="description" maxlength="500"><?php echo set_value('description'); ?></textarea>
                ...
                <div class="box-footer">
                  ...
                  <a href="/Admin/themes" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
                </div>
              </form>
          </div>
      </div>
