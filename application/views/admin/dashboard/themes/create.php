            ...
            <div class="box-body">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="theme_name" id="theme_name" class="form-control" value="<?php echo set_value('theme_name'); ?>" maxlength="50">
                  <span style="color:red" class="help-block"><?php echo form_error('theme_name'); ?></span>
                </div>
                <div class="form-group">
                  <label>Author*</label>
                  <input type="text" name="author" id="author" class="form-control" value="<?php echo set_value('author'); ?>" maxlength="50">
                  <span style="color:red" class="help-block"><?php echo form_error('author'); ?></span>
                </div>
                <div class="form-group input-width center-block">
                  <label>Description</label>
                  <textarea class="form-control" name="description" id="description" maxlength="500"><?php echo set_value('description'); ?></textarea>
...
$('.cropped_image').on('click', function (ev) {
    ...
    var description = $('#description').val();
		$.ajax({
			url: "<?php echo base_url() ?>Admin/save_theme",
			type: "POST",
        ...
        else if (data == 'Theme added!') {
          alert(data);
          $(location).attr('href','<?php echo base_url() ?>Admin/themes');
        }
        else if (data == 'Theme not added') {
          alert(data);
        }
        else {
