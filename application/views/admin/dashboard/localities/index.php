    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="/Admin/add_localities" class="btn btn-success"><i class="fa fa-plus"></i> Add Locality</a>
                  ...
                  <tbody>
                      <?php foreach ($localities as $key => $locality): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="/Admin/view_locality/<?php echo $locality->locality_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                            <a href="/Admin/edit_locality/<?php echo $locality->locality_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                            <a href="/Admin/delete_locality/<?php echo $locality->locality_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
