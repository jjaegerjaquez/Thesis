  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/Admin/localities">localities</a></li>
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form class="" action="/Admin/update_locality/<?php echo $locality->locality_id?>" method="post" enctype="multipart/form-data">
