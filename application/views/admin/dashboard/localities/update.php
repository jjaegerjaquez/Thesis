  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Admin/localities">localities</a></li>
        <li class="active">Update <?php echo $locality->locality?></li>
      </ol>
    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Update Locality</h3>
        ...
        <div class="box-body">
          ...
          <div class="col-lg-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="locality" id="locality"class="form-control" placeholder="Enter locality name" value="<?php if (!empty($locality->locality)): ?><?php echo $locality->locality ?><?php endif; ?>">
              <span style="color:red" class="help-block"><?php echo form_error('locality'); ?></span>
            </div>
            <div class="form-group input-width center-block">
              <label>Description</label>
              <textarea class="form-control" name="description" id="description" rows="8"placeholder="Enter locality description"><?php if (!empty($locality->description)): ?><?php echo $locality->description ?><?php endif; ?></textarea>
              <span style="color:red" class="help-block"><?php echo form_error('description'); ?></span>
            </div>
          </div>
          <!-- <form class="" action="<?php echo base_url(); ?>Admin/update_locality/<?php echo $locality->locality_id?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label>Profile Image:
                <br>
            ...
            <div class="form-group">
              <label>Locality:</label>
              <input type="text" name="locality" class="form-control" value="<?php echo $locality->locality ?>" maxlength="50">
              <span style="color:red" class="help-block"><?php echo form_error('locality'); ?></span>
            </div>
            <div class="form-group input-width center-block">
              <label>Description:</label>
              <textarea class="form-control" name="description"><?php echo $locality->description ?></textarea>
              <span style="color:red" class="help-block"><?php echo form_error('description'); ?></span>
            </div>   -->
        </div>
            <!-- /.box-body -->
...
$('.cropped_image').on('click', function (ev) {
  if ($('#images').val()=='') {
    ...
    var description = $('#description').val();
		$.ajax({
			url: "<?php echo base_url() ?>Admin/update_locality/<?php echo $locality->locality_id?>",
			type: "POST",
        ...
        else if (data == 'Locality updated!') {
          $('#upload-lbl').hide();
          alert(data);
          $(location).attr('href','<?php echo base_url() ?>Admin/localities');
        }
        else if (data == 'Locality cannot be updated') {
          $('#upload-lbl').hide();
          alert(data);
        }
        else {
