          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              <tr>
                ...
                <td><img src="/public/img/locality-img/<?php echo $locality->image?>" class="img-responsive" style="width:350px"/></td>
              </tr>
              <tr>
            ...
            <a href="/Admin/localities" class="btn btn-danger pull-right"><i class="fa fa-chevron-left"></i> Back</a>
          </div>
        </div>
      </div>
    </section>
