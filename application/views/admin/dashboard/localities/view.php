  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View <?php echo $locality->locality?></li>
      </ol>
    <!-- Main content -->
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              <tr>
                ...
                <td>
                  <?php if (!empty($locality->image)): ?>
                    <img src="<?php echo $locality->image?>" class="img-responsive" style="width:350px"/>
                  <?php else: ?>
                    <img src="/public/img/def-img-l.jpg" class="img-responsive" style="width:350px"/>
                  <?php endif; ?>
                </td>
              </tr>
              <tr>
                <td><label>ID:</label></td>
                <td><?php echo $locality->locality_id;?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><?php echo $locality->description;?></td>
              </tr>
            </table>
            <a href="<?php echo base_url(); ?>Admin/localities" class="btn btn-danger pull-right"><i class="fa fa-chevron-left"></i> Back</a>
          </div>
        </div>
      </div>
    </section>
