  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View <?php echo $supplier->business_name?></li>
      </ol>
    <!-- Main content -->
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><?php echo $supplier->address;?>, <?php echo $supplier->locality;?></td>
              </tr>
              <tr>
                <td><label>Cellphone:</label></td>
                <td><?php echo $supplier->cellphone;?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><?php echo $supplier->website_url;?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><?php echo $supplier->theme;?></td>
              </tr>
              <tr>
                <td><label>Date joined:</label></td>
                <td><?php  echo date('F j Y',strtotime($supplier->date_created))?></td>
              </tr>
            </table>
            <a href="/Admin/suppliers" class="btn btn-danger pull-right"><i class="fa fa-chevron-left"></i> Back</a>
          </div>
        </div>
      </div>
    </section>
