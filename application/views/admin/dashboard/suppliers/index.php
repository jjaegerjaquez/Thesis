...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Suppliers
        <small>list of all suppliers</small>
      </h1>
      <ol class="breadcrumb">
                  ...
                  <tbody>
                      <?php foreach ($suppliers as $key => $supplier): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="/Admin/view_supplier/<?php echo $supplier->id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                            <a href="/Admin/delete_supplier/<?php echo $supplier->id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
