                  ...
                  <tbody>
                      <?php foreach ($suppliers as $key => $supplier): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>Admin/view_supplier/<?php echo $supplier->id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                            <a href="<?php echo base_url(); ?>Admin/delete_supplier/<?php echo $supplier->id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
