  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View <?php echo $category->category?></li>
      </ol>
    <!-- Main content -->
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              <tr>
                ...
                <td><img src="<?php echo base_url(); ?>public/img/icons/<?php echo $category->image?>" class="img-responsive" style="width:350px"/></td>
              </tr>
              <tr>
            ...
            <a href="<?php echo base_url(); ?>Admin/categories" class="btn btn-danger pull-right"><i class="fa fa-chevron-left"></i> Back</a>
          </div>
        </div>
      </div>
    </section>
