  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form class="" action="<?php echo base_url(); ?>Admin/update_category/<?php echo $category->category_id?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="category" class="form-control" value="<?php echo $category->category ?>" maxlength="50">
            ...
            <div class="box-footer">
              ...
              <a href="<?php echo base_url(); ?>Admin/categories" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
            </div>
          </form>
        </div>
    </section>
