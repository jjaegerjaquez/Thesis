  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body">
          <form class="" action="/Admin/update_category/<?php echo $category->category_id?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-footer">
              ...
              <a href="/Admin/categories" class="btn btn-danger"><i class="fa fa-chevron-left"></i> Back</a>
            </div>
          </form>
        </div>
    </section>
