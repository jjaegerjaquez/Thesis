  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="active treeview"><a href="<?php echo base_url(); ?>Admin/categories"><i class="fa fa-edit"></i> <span>Categories</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update <?php echo $category->category?></li>
      </ol>
        ...
        <div class="box-body">
          ...
          <div class="col-lg-6">
            ...
            <div class="form-group">
              ...
              <input type="text" name="category" class="form-control" value="<?php echo $category->category ?>" id="category" placeholder="Enter category">
              <span style="color:red" class="help-block"><?php echo form_error('category'); ?></span>
            </div>
            <div class="form-group input-width center-block">
              <label>Description</label>
              <textarea class="form-control" name="description" id="description" placeholder="Enter category description"><?php echo $category->description ?></textarea>
            ...
            <div class="form-group">
              ...
              <a href="<?php echo base_url(); ?>Admin/categories" class="btn btn-danger" style="margin-top:5px;"><i class="fa fa-chevron-left"></i> Back</a>
            </div>
          </div><!-- /.box-body -->
        </div>
      </div>
...
$('.cropped_image').on('click', function (ev) {
  if ($('#images').val()=='') {
    ...
    var description = $('#description').val();
		$.ajax({
			url: "<?php echo base_url() ?>Admin/update_category/<?php echo $category->category_id?>",
			type: "POST",
			data: {"image":response,"file":file_input,"category":category,"description":description},
