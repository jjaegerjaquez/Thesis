    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          ...
          <a href="<?php echo base_url(); ?>Admin/add_category" class="btn btn-success"><i class="fa fa-plus"></i> Add Category</a>
                  ...
                  <tbody>
                      <?php foreach ($categories as $key => $category): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>Admin/view_category/<?php echo $category->category_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                            <a href="<?php echo base_url(); ?>Admin/edit_category/<?php echo $category->category_id  ?>" class="btn btn-warning"><i class="fa fa-pencil"></i> Edit</a>
                            <a href="<?php echo base_url(); ?>Admin/delete_category/<?php echo $category->category_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
