          ...
          <div class="box-body">
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="category" class="form-control" value="<?php echo $account->username;?>" id="username" placeholder="Enter username">
                <span style="color:red" class="help-block"><?php echo form_error('username'); ?></span>
              </div>
              <div class="form-group input-width center-block">
                <label>Password:</label>
                <input type="password" name="password" class="form-control" value="" maxlength="50" id="password" placeholder="Enter password">
...
$('.cropped_image').on('click', function (ev) {
  if ($('#images').val()=='') {
    ...
    var password = $('#password').val();
		$.ajax({
			url: "<?php echo base_url() ?>Admin/update_account/<?php echo $account->admin_id ?>",
			type: "POST",
        ...
        else if (data == 'Account updated!') {
          $('#upload-lbl').hide();
          alert(data);
          $(location).attr('href','<?php echo base_url() ?>Admin/accounts');
        }
        else if (data == 'Account cannot be updated') {
          $('#upload-lbl').hide();
          alert(data);
        }
        else {
