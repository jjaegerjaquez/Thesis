  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>Admin/reviews">Reviews</a></li>
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="table-responsive">
            ...
            <a href="<?php echo base_url(); ?>Admin/reviews" class="btn btn-danger pull-right"><i class="fa fa-chevron-left"></i> Back</a>
          </div>
        </div>
      </div>
    </section>
