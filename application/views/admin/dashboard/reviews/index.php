...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Reviews
        <small>list of all reviews</small>
      </h1>
      <ol class="breadcrumb">
                  ...
                  <tbody>
                      <?php foreach ($reviews as $key => $review): ?>
                        <tr role="row" class="odd">
                          ...
                          <td>
                            <a href="/Admin/view_review/<?php echo $review->review_id ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                            <a href="/Admin/delete_review/<?php echo $review->review_id  ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                          </td>
                        </tr>
                      <?php endforeach ?>
                  </tbody>
