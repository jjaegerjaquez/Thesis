  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu">
        ...
        <li class="treeview"><a href="/"><i class="fa fa-navicon"></i> <span>Home</span></a></li>
        <li class="treeview"><a href="/"><i class="fa fa-male"></i> <span>Profile</span></a></li>
        <li class="treeview"><a href="/"><i class="fa fa-edit"></i> <span>About</span></a></li>
        <li class="treeview"><a href="/"><i class="fa fa-user"></i> <span>Contacts</span></a></li>
        <!-- <li class="treeview">
