...
class Lights extends CI_Model
{
  ...
  public function get_home_background_image($user_id,$business_name)
  {
  ...
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and business_name = '$this->BusinessName' and meta_key = 'facebook_url'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
  ...
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and business_name = '$this->BusinessName' and meta_key = 'instagram_url'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
  ...
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and business_name = '$this->BusinessName' and meta_key = 'twitter_url'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
