...
class Lights extends CI_Model
{
  ...
  public function get_home_background_image($user_id,$id)
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and id = '$id' and meta_key = 'home_background_image'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
  ...
  public function get_about_background_image($user_id,$id)
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and id = '$id' and meta_key = 'about_background_image'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
  ...
  public function get_about_title($user_id,$id)
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and id = '$id' and meta_key = 'about_title'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
  ...
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and id = '$this->id' and meta_key = 'facebook_url'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
  ...
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and id = '$this->id' and meta_key = 'instagram_url'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
  ...
  {
    $query = $this->db->query("SELECT * FROM `contents` WHERE user_id = '$user_id' and id = '$this->id' and meta_key = 'twitter_url'");
    if ($query->num_rows() > 0) {
      return $query->row();
    }else {
      return FALSE;
